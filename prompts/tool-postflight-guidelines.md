- Post-flight runs AUTOMATICALLY when you call tdd_stop on a feature with passing tests and a spec checklist. Usually, you can let that automatic path handle the review and simply disengage when the feature is done.
